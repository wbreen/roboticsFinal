...
//
//            robot.motorLeft.setPower(-0.3 - turn);
//            robot.motorRight.setPower(0.3 + turn);
//
//            loopCounter++;
...
//        robot.moveRobot(robot.SLOW_POWER,2); //just to be sure it's in the right spot
        ...
        sleep(2000);
        robot.pos60(); // contains return bucket code
        sleep(10000);
        robot.returnBucket();
